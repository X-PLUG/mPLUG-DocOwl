...
## 📢 News
* 🔥🔥🔥 [2024.4.26] We release the arxiv paper of [TinyChart](https://arxiv.org/abs/2404.16635), a SOTA 3B Multimodal LLM for Chart Understanding (ChartQA: 83.6 > Gemin-Ultra 80.8 > GPT4V 78.5). The demo of TinyChart is available on [HuggingFace](https://huggingface.co/spaces/mPLUG/TinyChart-3B) 🤗. Both codes, models and data are released in [TinyChart](./TinyChart/).
...
### 📖 DocOwl 1.5
<a href="https://modelscope.cn/studios/iic/mPLUG-DocOwl/summary"><img src="https://modelscope.oss-cn-beijing.aliyuncs.com/modelscope.gif" width="250"/></a><a href="https://huggingface.co/spaces/mPLUG/DocOwl"><img src="./assets/huggingface.png" width="250"/></a>

### 📈 TinyChart-3B
<a href="https://huggingface.co/spaces/mPLUG/TinyChart-3B"><img src="./assets/huggingface.png" width="250"/></a>
